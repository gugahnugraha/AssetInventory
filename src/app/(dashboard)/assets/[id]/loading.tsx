  ...
  return (
    <div className="w-full min-h-[70vh] flex flex-col items-center justify-center gap-4 animate-in fade-in-0 duration-300">
      ...
      <div className="flex flex-col items-center gap-1">
        <span className="text-sm font-bold text-zinc-800 tracking-wide">Memuat detail aset...</span>
        <span className="text-[10px] text-zinc-500">Menyiapkan data inventaris</span>
      </div>
    </div>
  );
}
